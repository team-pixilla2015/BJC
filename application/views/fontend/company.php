...
<div class="contain">
  <div class="container">
  <section id="banner">
    <img src="<?php echo base_url(); ?>assets/FE/images/company/banner01.jpg">
  </section>
  <section id="introcp">
    <div class="wrapper">
      <div class="hintrocp">
  ...
  <section id="bjcgroup">
    ...
    <div id="tabsgroup" class="">
      <div class="imgctrtabs">
        <img src="<?php echo base_url(); ?>assets/FE/images/company/choice01.png">
      </div>
      <ul class="ultabs">
        <li>
          <a href="#tabs1">
      ...
      <div id="tabs1" class="showtabs">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img01.png">
              </div>
              <div class="descbjcg">
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img02.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img03.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img04.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img05.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img06.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img07.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img08.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img09.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img10.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img11.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img12.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img13.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img14.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img15.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
          ...
          <div class="col-xs-12 col-sm-12 col-md-3 col-lg-2">
            <div class="listbjcg">
              <div class="imgbjcg">
                <img src="<?php echo base_url(); ?>assets/FE/images/company/img16.png">
              </div>
              <div class="descbjcg">
                <h5 class="ncp">Company</h5>
                <p class="typecp">Business Group</p>
    ...
    <div class="exploreAS">
      ...
      <div class="imgexplore">
        <img src="<?php echo base_url(); ?>assets/FE/images/company/chart.jpg">
      </div>
    </div>
  </section>
  <section id="blogbod">
    ...
    <div class="blogbod">
      ...
      <div class="bod">
          ...
          <div class="descbod">
	        ...
	        <div class="listbod">
          <div class="imgbod">
            <img src="<?php echo base_url(); ?>assets/FE/images/company/pn02.png">
          </div>
          <div class="descbod">
            <h3 class="txt-dbod">
	        ...
	        <div class="listbod">
          <div class="imgbod">
            <img src="<?php echo base_url(); ?>assets/FE/images/company/pn03.png">
          </div>
          <div class="descbod">
            <h3 class="txt-dbod">
	        ...
	        <div class="listbod">
          <div class="imgbod">
            <img src="<?php echo base_url(); ?>assets/FE/images/company/pn04.png">
          </div>
          <div class="descbod">
            <h3 class="txt-dbod">
	        ...
	        <div class="listbod">
          <div class="imgbod">
            <img src="<?php echo base_url(); ?>assets/FE/images/company/pn05.png">
          </div>
          <div class="descbod">
            <h3 class="txt-dbod">
          ...
          กรรมการบริษัท / รองประธานกรรมการบริหาร / กรรมการบริหารความเสี่ยง
	        ...
	        <div class="listbod">
          <div class="imgbod">
            <img src="<?php echo base_url(); ?>assets/FE/images/company/pn06.png">
          </div>
          <div class="descbod">
            <h3 class="txt-dbod">
           นายฐาปน สิริวัฒนภักดี
	        ...
	        <div class="listbod">
          <div class="imgbod">
            <img src="<?php echo base_url(); ?>assets/FE/images/company/pn07.png">
          </div>
          <div class="descbod">
            <h3 class="txt-dbod">
	        ...
	        <div class="listbod">
          <div class="imgbod">
            <img src="<?php echo base_url(); ?>assets/FE/images/company/pn08.png">
          </div>
          <div class="descbod">
            <h3 class="txt-dbod">
	        ...
	        <div class="listbod">
          <div class="imgbod">
            <img src="<?php echo base_url(); ?>assets/FE/images/company/pn09.png">
          </div>
          <div class="descbod">
            <h3 class="txt-dbod">
	        ...
	        <div class="listbod">
          <div class="imgbod">
            <img src="<?php echo base_url(); ?>assets/FE/images/company/pn10.png">
          </div>
          <div class="descbod">
            <h3 class="txt-dbod">
	        ...
	        <div class="listbod">
          <div class="imgbod">
            <img src="<?php echo base_url(); ?>assets/FE/images/company/pn11.png">
          </div>
          <div class="descbod">
            <h3 class="txt-dbod">
	        ...
	        <div class="listbod">
          <div class="imgbod">
            <img src="<?php echo base_url(); ?>assets/FE/images/company/pn12.png">
          </div>
          <div class="descbod">
            <h3 class="txt-dbod">
	        ...
	        <div class="listbod">
          <div class="imgbod">
            <img src="<?php echo base_url(); ?>assets/FE/images/company/pn13.png">
          </div>
          <div class="descbod">
            <h3 class="txt-dbod">
...
/ กรรมการรองผู้จัดการใหญ่อาวุโส
    ...
    <div class="mngb">
      ...
      <div class="blogmngb">
          ...
          <div class="listmngb">
            <div class="imgmngb">
              <img src="<?php echo base_url(); ?>assets/FE/images/company/spn01.png">
            </div>
            <div class="descmngb">
              <h3 class="txt-dmngb">
                นายอัศวิน เตชะเจริญวิกุล
          ...
          <div class="listmngb">
            <div class="imgmngb">
              <img src="<?php echo base_url(); ?>assets/FE/images/company/spn02.png">
            </div>
            <div class="descmngb">
              <h3 class="txt-dmngb">
               นางฐาปณี เตชะเจริญวิกุล
...
/ กรรมการรองผู้จัดการใหญ่อาวุโส
          ...
          <div class="listmngb">
            <div class="imgmngb">
              <img src="<?php echo base_url(); ?>assets/FE/images/company/spn03.png">
            </div>
            <div class="descmngb">
              <h3 class="txt-dmngb">
          ...
          <div class="listmngb">
            <div class="imgmngb">
              <img src="<?php echo base_url(); ?>assets/FE/images/company/spn04.png">
            </div>
            <div class="descmngb">
              <h3 class="txt-dmngb">
          ...
          <div class="listmngb">
            <div class="imgmngb">
              <img src="<?php echo base_url(); ?>assets/FE/images/company/spn05.png">
            </div>
            <div class="descmngb">
              <h3 class="txt-dmngb">
               นางวิภาดา ดวงรัตน์
          ...
          <div class="listmngb">
            <div class="imgmngb">
              <img src="<?php echo base_url(); ?>assets/FE/images/company/spn06.png">
            </div>
            <div class="descmngb">
              <h3 class="txt-dmngb">
          ...
          <div class="listmngb">
            <div class="imgmngb">
              <img src="<?php echo base_url(); ?>assets/FE/images/company/spn07.png">
            </div>
            <div class="descmngb">
              <h3 class="txt-dmngb">
               นายมนัส มนูญชัย
          ...
          <div class="listmngb">
            <div class="imgmngb">
              <img src="<?php echo base_url(); ?>assets/FE/images/company/spn08.png">
            </div>
            <div class="descmngb">
              <h3 class="txt-dmngb">
  ...
  <section id="valandcul">
    <div class="wrapper">
      ...
      <div class="slidevac">
        <div class="imgvac">
          <img src="<?php echo base_url(); ?>assets/FE/images/company/tree01.png">
        </div>
