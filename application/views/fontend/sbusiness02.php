<script type="text/javascript">
  ...
  <section>
    <div class="wrapper">
      <img src="<?php echo base_url(); ?>assets/FE/images/bu/s02.jpg" style="width:100%" usemap="#planetmap">
      <map name="planetmap">
        <area shape="rect" coords="843,440,985,460" href="business02.php" alt="Sun">
    </div>
  </section>
